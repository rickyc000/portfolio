            ...
            <div className="back-to-top-wrapper">
              <Link
                ...
                <div className="back-to-top">
                  <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" fill="#000000" className="bi bi-arrow-up" viewBox="0 0 16 16">
            ...
            <div className="email-footer-wrapper">
              <div className="footer-email">
                <a href="mailto:r.cato@live.com" target="_blank" rel="noopener noreferrer">
                  ...
                  <p className="contact-label">r.cato@live.com</p>
                </a>
              </div>
            </div>
          </div>
